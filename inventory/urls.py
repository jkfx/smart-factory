...
urlpatterns = [
    ...
    path(
        "view_all_transaction/", views.view_all_transaction, name="view_all_transaction"
    ),
    # For Employee
    ...
    path(
        "<int:emp_id>/delete_employee/", views.delete_employee, name="delete_employee"
    ),
    ...
    path(
        "<int:cus_id>/delete_customer/", views.delete_customer, name="delete_customer"
    ),
    # For orders
    ...
    path(
        "<int:sup_id>/delete_supplier/", views.delete_supplier, name="delete_supplier"
    ),
    # For Raw Materials
    ...
    path(
        "<int:mat_id>/delete_material/", views.delete_material, name="delete_material"
    ),
